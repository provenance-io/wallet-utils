...
export const QueryUpgradeErrorRequest: MessageFns<QueryUpgradeErrorRequest> = {
  encode(message: QueryUpgradeErrorRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.portId !== "") {
      writer.uint32(10).string(message.portId);
    }
    if (message.channelId !== "") {
...
export const QueryUpgradeErrorResponse: MessageFns<QueryUpgradeErrorResponse> = {
  encode(message: QueryUpgradeErrorResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.errorReceipt !== undefined) {
      ErrorReceipt.encode(message.errorReceipt, writer.uint32(10).fork()).join();
    }
    if (message.proof.length !== 0) {
      writer.uint32(18).bytes(message.proof);
    }
...
export const QueryUpgradeRequest: MessageFns<QueryUpgradeRequest> = {
  encode(message: QueryUpgradeRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.portId !== "") {
      writer.uint32(10).string(message.portId);
    }
    if (message.channelId !== "") {
...
export const QueryUpgradeResponse: MessageFns<QueryUpgradeResponse> = {
  encode(message: QueryUpgradeResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
...
export const QueryChannelParamsRequest: MessageFns<QueryChannelParamsRequest> = {
  encode(_: QueryChannelParamsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
export const QueryChannelParamsResponse: MessageFns<QueryChannelParamsResponse> = {
  encode(message: QueryChannelParamsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
