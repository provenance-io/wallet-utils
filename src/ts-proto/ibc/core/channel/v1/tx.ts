...
export const MsgChannelCloseConfirm: MessageFns<MsgChannelCloseConfirm> = {
  encode(message: MsgChannelCloseConfirm, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (!message.counterpartyUpgradeSequence.equals(Long.UZERO)) {
      writer.uint32(48).uint64(message.counterpartyUpgradeSequence.toString());
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6: {
          ...
          message.counterpartyUpgradeSequence = Long.fromString(reader.uint64().toString(), true);
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
...
export const MsgTimeoutOnClose: MessageFns<MsgTimeoutOnClose> = {
  encode(message: MsgTimeoutOnClose, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (!message.counterpartyUpgradeSequence.equals(Long.UZERO)) {
      writer.uint32(56).uint64(message.counterpartyUpgradeSequence.toString());
    }
    return writer;
  },
...
export const MsgChannelUpgradeInit: MessageFns<MsgChannelUpgradeInit> = {
  encode(message: MsgChannelUpgradeInit, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.portId !== "") {
      writer.uint32(10).string(message.portId);
    }
    if (message.channelId !== "") {
    ...
    if (message.fields !== undefined) {
      UpgradeFields.encode(message.fields, writer.uint32(26).fork()).join();
    }
    if (message.signer !== "") {
      writer.uint32(34).string(message.signer);
    }
...
export const MsgChannelUpgradeInitResponse: MessageFns<MsgChannelUpgradeInitResponse> = {
  encode(message: MsgChannelUpgradeInitResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.upgrade !== undefined) {
      Upgrade.encode(message.upgrade, writer.uint32(10).fork()).join();
    }
    if (!message.upgradeSequence.equals(Long.UZERO)) {
      writer.uint32(16).uint64(message.upgradeSequence.toString());
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.upgradeSequence = Long.fromString(reader.uint64().toString(), true);
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
...
export const MsgChannelUpgradeTry: MessageFns<MsgChannelUpgradeTry> = {
  encode(message: MsgChannelUpgradeTry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.portId !== "") {
      writer.uint32(10).string(message.portId);
    }
    if (message.channelId !== "") {
    ...
    if (message.counterpartyUpgradeFields !== undefined) {
      UpgradeFields.encode(message.counterpartyUpgradeFields, writer.uint32(34).fork()).join();
    }
    if (!message.counterpartyUpgradeSequence.equals(Long.UZERO)) {
      writer.uint32(40).uint64(message.counterpartyUpgradeSequence.toString());
    }
    ...
    if (message.proofHeight !== undefined) {
      Height.encode(message.proofHeight, writer.uint32(66).fork()).join();
    }
    if (message.signer !== "") {
...
export const MsgChannelUpgradeTryResponse: MessageFns<MsgChannelUpgradeTryResponse> = {
  encode(message: MsgChannelUpgradeTryResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.upgrade !== undefined) {
      Upgrade.encode(message.upgrade, writer.uint32(10).fork()).join();
    }
    if (!message.upgradeSequence.equals(Long.UZERO)) {
...
export const MsgChannelUpgradeAck: MessageFns<MsgChannelUpgradeAck> = {
  encode(message: MsgChannelUpgradeAck, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.portId !== "") {
      writer.uint32(10).string(message.portId);
    }
    if (message.channelId !== "") {
    ...
    if (message.counterpartyUpgrade !== undefined) {
      Upgrade.encode(message.counterpartyUpgrade, writer.uint32(26).fork()).join();
    }
    if (message.proofChannel.length !== 0) {
...
export const MsgChannelUpgradeAckResponse: MessageFns<MsgChannelUpgradeAckResponse> = {
  encode(message: MsgChannelUpgradeAckResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.result !== 0) {
      writer.uint32(8).int32(message.result);
    }
    return writer;
...
export const MsgChannelUpgradeConfirm: MessageFns<MsgChannelUpgradeConfirm> = {
  encode(message: MsgChannelUpgradeConfirm, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.portId !== "") {
      writer.uint32(10).string(message.portId);
    }
    if (message.channelId !== "") {
    ...
    if (message.counterpartyUpgrade !== undefined) {
      Upgrade.encode(message.counterpartyUpgrade, writer.uint32(34).fork()).join();
    }
    if (message.proofChannel.length !== 0) {
...
export const MsgChannelUpgradeConfirmResponse: MessageFns<MsgChannelUpgradeConfirmResponse> = {
  encode(message: MsgChannelUpgradeConfirmResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.result !== 0) {
      writer.uint32(8).int32(message.result);
    }
    return writer;
...
export const MsgChannelUpgradeOpen: MessageFns<MsgChannelUpgradeOpen> = {
  encode(message: MsgChannelUpgradeOpen, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.portId !== "") {
      writer.uint32(10).string(message.portId);
    }
    if (message.channelId !== "") {
    ...
    if (!message.counterpartyUpgradeSequence.equals(Long.UZERO)) {
      writer.uint32(32).uint64(message.counterpartyUpgradeSequence.toString());
    }
    if (message.proofChannel.length !== 0) {
      writer.uint32(42).bytes(message.proofChannel);
    }
...
export const MsgChannelUpgradeOpenResponse: MessageFns<MsgChannelUpgradeOpenResponse> = {
  encode(_: MsgChannelUpgradeOpenResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
export const MsgChannelUpgradeTimeout: MessageFns<MsgChannelUpgradeTimeout> = {
  encode(message: MsgChannelUpgradeTimeout, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.portId !== "") {
      writer.uint32(10).string(message.portId);
    }
    if (message.channelId !== "") {
    ...
    if (message.counterpartyChannel !== undefined) {
      Channel.encode(message.counterpartyChannel, writer.uint32(26).fork()).join();
    }
    if (message.proofChannel.length !== 0) {
      writer.uint32(34).bytes(message.proofChannel);
    }
...
export const MsgChannelUpgradeTimeoutResponse: MessageFns<MsgChannelUpgradeTimeoutResponse> = {
  encode(_: MsgChannelUpgradeTimeoutResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
export const MsgChannelUpgradeCancel: MessageFns<MsgChannelUpgradeCancel> = {
  encode(message: MsgChannelUpgradeCancel, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.portId !== "") {
      writer.uint32(10).string(message.portId);
    }
    if (message.channelId !== "") {
    ...
    if (message.errorReceipt !== undefined) {
      ErrorReceipt.encode(message.errorReceipt, writer.uint32(26).fork()).join();
    }
...
export const MsgChannelUpgradeCancelResponse: MessageFns<MsgChannelUpgradeCancelResponse> = {
  encode(_: MsgChannelUpgradeCancelResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
export const MsgPruneAcknowledgements: MessageFns<MsgPruneAcknowledgements> = {
  encode(message: MsgPruneAcknowledgements, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.portId !== "") {
      writer.uint32(10).string(message.portId);
    }
    if (message.channelId !== "") {
...
export const MsgPruneAcknowledgementsResponse: MessageFns<MsgPruneAcknowledgementsResponse> = {
  encode(message: MsgPruneAcknowledgementsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (!message.totalPrunedSequences.equals(Long.UZERO)) {
      writer.uint32(8).uint64(message.totalPrunedSequences.toString());
    }
    if (!message.totalRemainingSequences.equals(Long.UZERO)) {
      writer.uint32(16).uint64(message.totalRemainingSequences.toString());
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.totalPrunedSequences = Long.fromString(reader.uint64().toString(), true);
          continue;
        }
        case 2: {
          if (tag !== 16) {
          ...
          message.totalRemainingSequences = Long.fromString(reader.uint64().toString(), true);
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
