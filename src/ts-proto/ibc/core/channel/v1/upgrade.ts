...
export const Upgrade: MessageFns<Upgrade> = {
  encode(message: Upgrade, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.fields !== undefined) {
      UpgradeFields.encode(message.fields, writer.uint32(10).fork()).join();
    }
    if (message.timeout !== undefined) {
      Timeout.encode(message.timeout, writer.uint32(18).fork()).join();
    }
    if (!message.nextSequenceSend.equals(Long.UZERO)) {
      writer.uint32(24).uint64(message.nextSequenceSend.toString());
    }
    return writer;
  },
...
export const UpgradeFields: MessageFns<UpgradeFields> = {
  encode(message: UpgradeFields, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
...
export const ErrorReceipt: MessageFns<ErrorReceipt> = {
  encode(message: ErrorReceipt, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
