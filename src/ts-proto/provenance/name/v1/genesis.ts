...
function createBaseGenesisState(): GenesisState {
  return { params: undefined, bindings: [] };
}
...
export const GenesisState: MessageFns<GenesisState> = {
  encode(message: GenesisState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.bindings) {
      NameRecord.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.bindings.push(NameRecord.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      bindings: globalThis.Array.isArray(object?.bindings)
        ? object.bindings.map((e: any) => NameRecord.fromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.bindings?.length) {
      obj.bindings = message.bindings.map((e) => NameRecord.toJSON(e));
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(object: I): GenesisState {
    ...
    message.params = (object.params !== undefined && object.params !== null)
      ...
      : undefined;
    message.bindings = object.bindings?.map((e) => NameRecord.fromPartial(e)) || [];
    return message;
  },
};
