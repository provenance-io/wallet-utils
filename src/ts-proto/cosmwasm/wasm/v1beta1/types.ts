...
export const Params: MessageFns<Params> = {
  encode(message: Params, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (!message.maxWasmCodeSize.equals(Long.UZERO)) {
      writer.uint32(24).uint64(message.maxWasmCodeSize.toString());
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.maxWasmCodeSize = Long.fromString(reader.uint64().toString(), true);
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
...
function createBaseCodeInfo(): CodeInfo {
  return { codeHash: new Uint8Array(0), creator: "", source: "", builder: "", instantiateConfig: undefined };
}
