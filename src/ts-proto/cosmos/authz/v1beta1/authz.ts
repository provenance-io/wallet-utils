 ...
 */
export interface CountAuthorization {
  /** Msg, identified by it's type URL, to grant unrestricted permissions to execute */
  msg: string;
  /** Allowed number of authorizations assigned to grantee */
  allowedAuthorizations: number;
}
...
function createBaseCountAuthorization(): CountAuthorization {
  return { msg: "", allowedAuthorizations: 0 };
}

export const CountAuthorization: MessageFns<CountAuthorization> = {
  encode(message: CountAuthorization, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.msg !== "") {
      writer.uint32(10).string(message.msg);
    }
    if (message.allowedAuthorizations !== 0) {
      writer.uint32(16).int32(message.allowedAuthorizations);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CountAuthorization {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCountAuthorization();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 2: {
          ...
          message.allowedAuthorizations = reader.int32();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): CountAuthorization {
    return {
      msg: isSet(object.msg) ? globalThis.String(object.msg) : "",
      allowedAuthorizations: isSet(object.allowedAuthorizations) ? globalThis.Number(object.allowedAuthorizations) : 0,
    };
  },

  toJSON(message: CountAuthorization): unknown {
    const obj: any = {};
    if (message.msg !== "") {
      obj.msg = message.msg;
    }
    if (message.allowedAuthorizations !== 0) {
      obj.allowedAuthorizations = Math.round(message.allowedAuthorizations);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<CountAuthorization>, I>>(base?: I): CountAuthorization {
    return CountAuthorization.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CountAuthorization>, I>>(object: I): CountAuthorization {
    const message = createBaseCountAuthorization();
    message.msg = object.msg ?? "";
    message.allowedAuthorizations = object.allowedAuthorizations ?? 0;
    return message;
  },
};
