...
export const ListRequest_Prefix: MessageFns<ListRequest_Prefix> = {
  encode(message: ListRequest_Prefix, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.values) {
...
export const ListRequest_Range: MessageFns<ListRequest_Range> = {
  encode(message: ListRequest_Range, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
...
export const IndexValue: MessageFns<IndexValue> = {
  encode(message: IndexValue, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.uint !== undefined) {
      writer.uint32(8).uint64(message.uint.toString());
    }
    if (message.int !== undefined) {
      writer.uint32(16).int64(message.int.toString());
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.uint = Long.fromString(reader.uint64().toString(), true);
          continue;
        }
        case 2: {
          if (tag !== 16) {
          ...
          message.int = Long.fromString(reader.int64().toString());
          continue;
        }
        case 3: {
          if (tag !== 26) {
