...
export const TableDescriptor: MessageFns<TableDescriptor> = {
  encode(message: TableDescriptor, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
...
export const PrimaryKeyDescriptor: MessageFns<PrimaryKeyDescriptor> = {
  encode(message: PrimaryKeyDescriptor, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.fields !== "") {
...
export const SecondaryIndexDescriptor: MessageFns<SecondaryIndexDescriptor> = {
  encode(message: SecondaryIndexDescriptor, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.fields !== "") {
      writer.uint32(10).string(message.fields);
    }
    if (message.id !== 0) {
...
export const SingletonDescriptor: MessageFns<SingletonDescriptor> = {
  encode(message: SingletonDescriptor, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== 0) {
