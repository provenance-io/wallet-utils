...
import { Input, Metadata, Output, Params, SendEnabled } from "./bank";
...
export interface MsgUpdateDenomMetadata {
  fromAddress: string;
  title: string;
  description: string;
...
export interface MsgUpdateDenomMetadataResponse {
}
...
function createBaseMsgUpdateDenomMetadata(): MsgUpdateDenomMetadata {
  return { fromAddress: "", title: "", description: "", metadata: undefined };
}

export const MsgUpdateDenomMetadata: MessageFns<MsgUpdateDenomMetadata> = {
  encode(message: MsgUpdateDenomMetadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.fromAddress !== "") {
      writer.uint32(10).string(message.fromAddress);
    }
    if (message.title !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgUpdateDenomMetadata {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgUpdateDenomMetadata();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): MsgUpdateDenomMetadata {
    return {
      fromAddress: isSet(object.fromAddress) ? globalThis.String(object.fromAddress) : "",
  ...
  toJSON(message: MsgUpdateDenomMetadata): unknown {
    const obj: any = {};
    if (message.fromAddress !== "") {
      obj.fromAddress = message.fromAddress;
    }
  ...
  create<I extends Exact<DeepPartial<MsgUpdateDenomMetadata>, I>>(base?: I): MsgUpdateDenomMetadata {
    return MsgUpdateDenomMetadata.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgUpdateDenomMetadata>, I>>(object: I): MsgUpdateDenomMetadata {
    const message = createBaseMsgUpdateDenomMetadata();
    message.fromAddress = object.fromAddress ?? "";
...
function createBaseMsgUpdateDenomMetadataResponse(): MsgUpdateDenomMetadataResponse {
  return {};
}

export const MsgUpdateDenomMetadataResponse: MessageFns<MsgUpdateDenomMetadataResponse> = {
  encode(_: MsgUpdateDenomMetadataResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgUpdateDenomMetadataResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgUpdateDenomMetadataResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
      }
  ...
  fromJSON(_: any): MsgUpdateDenomMetadataResponse {
    return {};
  },

  toJSON(_: MsgUpdateDenomMetadataResponse): unknown {
    const obj: any = {};
    return obj;
  },

  create<I extends Exact<DeepPartial<MsgUpdateDenomMetadataResponse>, I>>(base?: I): MsgUpdateDenomMetadataResponse {
    return MsgUpdateDenomMetadataResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgUpdateDenomMetadataResponse>, I>>(_: I): MsgUpdateDenomMetadataResponse {
    const message = createBaseMsgUpdateDenomMetadataResponse();
    return message;
  },
};
...
export interface Msg {
  ...
  UpdateDenomMetadata(request: MsgUpdateDenomMetadata): Promise<MsgUpdateDenomMetadataResponse>;
}
...
export class MsgClientImpl implements Msg {
  ...
  constructor(rpc: Rpc, opts?: { service?: string }) {
    ...
    this.UpdateDenomMetadata = this.UpdateDenomMetadata.bind(this);
  }
  Send(request: MsgSend): Promise<MsgSendResponse> {
  ...
  UpdateDenomMetadata(request: MsgUpdateDenomMetadata): Promise<MsgUpdateDenomMetadataResponse> {
    const data = MsgUpdateDenomMetadata.encode(request).finish();
    const promise = this.rpc.request(this.service, "UpdateDenomMetadata", data);
    return promise.then((data) => MsgUpdateDenomMetadataResponse.decode(new BinaryReader(data)));
  }
}
